...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(battery virtualenv status command_execution_time background_jobs todo ram load rvm time)
...
[ -f ~/.oh-my-zsh/custom/plugins/zsh-colorls/.fzf.zsh ] && source ~/.oh-my-zsh/custom/plugins/zsh-colorls/.fzf.zsh
